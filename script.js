...
const githubData = {
    username: 'thurunu',
    avatarUrl: 'https://avatars.githubusercontent.com/u/your-github-user-id?v=4',
    stats: {
        repositories: 15,
        followers: 25
    },
    repositories: [
        {
            ...
            description: 'A VSCode themed developer portfolio built with HTML, CSS, and JavaScript',
            language: 'CSS',
            languageColor: '#563d7c',
            stars: 12,
            forks: 5,
            watchers: 12,
            githubUrl: 'https://github.com/thurunu/portfolio-vscode',
            liveUrl: 'https://your-portfolio-url.com'
        },
        {
            name: 'skin-detection-api',
            description: 'AI-powered skin oiliness detection API using computer vision and machine learning',
            language: 'Python',
            languageColor: '#3572A5',
            stars: 8,
            forks: 3,
            watchers: 8,
            githubUrl: 'https://github.com/thurunu/skin-detection-api',
            liveUrl: null
        },
        {
            name: 'spring-boot-microservices',
            description: 'Microservices architecture implementation using Spring Boot and Docker',
            language: 'Java',
            languageColor: '#b07219',
            stars: 6,
            forks: 2,
            watchers: 6,
            githubUrl: 'https://github.com/thurunu/spring-boot-microservices',
            liveUrl: null
        }
    ],
    contributions: {
...
// Tab switching functionality
        ...
        function updateGitHubProfile() {
            ...
            if (avatar) {
                avatar.src = githubData.avatarUrl;
            ...
            if (username) {
                username.textContent = githubData.username;
            }
            
            // Update stats
            const repoStat = document.querySelector('.stat-item:first-child span');
            if (repoStat) {
                repoStat.textContent = `${githubData.stats.repositories} repositories`;
            }
            
            const followerStat = document.querySelector('.stat-item:last-child span');
            if (followerStat) {
                followerStat.textContent = `${githubData.stats.followers} followers`;
            }
        }
